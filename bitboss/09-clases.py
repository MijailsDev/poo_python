...
mi_personaje = Personaje("BitBoss", 10, 1, 5, 0) # cambiamos el valor de la vida
print(mi_personaje.esta_vivo()) # Nos duelve un False

"""
mi_personaje = Personaje("BitBoss", 10, 1, 5, 100) 
print(mi_personaje.esta_vivo())  # Nos duelve un True
"""